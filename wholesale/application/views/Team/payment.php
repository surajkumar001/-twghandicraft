                ...
                <div class="row">
                    <div class="panel panel-primary ">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                       ...
                                       <option value="online_transaction_id"  <?php if($type == 'online_transaction_id'){ echo 'selected' ;} ?> >Paytm Tr Id.</option>
                        ...
                        <div class="row">    
                            ...
                            <table class="table table-bordered clienttable"  style=" margin: 0 auto;
                                                                                      width: 99%;
                                                                                      clear: both;
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 ...
                                 <tr>
                                     ...
                                     <td>        <p><?php if($payment_mode == 'Online' ) {

    ...
    <!-- Modal -->
    <div id="myModal" class="modal fade modal-lg modal-dialog-centered" role="dialog" style="left: 18%;">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Login and Register First</h4>
                            ...
                            <?php      $logo  = $this->db->get_where('cms', array('id' => 11 ,))->row() ;
?>
          <div class="modal-body">
            <img src="<?= $logo->terms ;?>" class="img img-responsive">
          </div>
          <div class="modal-footer">
            <a href="<?= base_url('login') ; ?>" class="btn btn-primary btn-xs">Login</a>
            <a href="<?= base_url('Artnhub/preRegistration') ; ?>" class="btn btn-success btn-xs">Register</a>
          </div>
        </div>

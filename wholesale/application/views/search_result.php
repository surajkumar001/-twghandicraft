...
<!-- ============================================== filter-end ============================================== -->
    ...
    <?php } ?>  
        ...
        <input type="hidden" id="catid" value="<?php echo $search; ?>">
             ...
             <div class="products-carousel carousel-without-attributes">
               <div class="woocommerce columns-7">                 
                  <div class="products  slick-initialized slick-slider slick-dotted" role="toolbar" style="padding-bottom: 70px;">
                        ...
                        <?php } ?>
                           <div class="product_list_container">
                            <div class="product_list_img">  
                             <img src="<?php echo base_url('assets/product/'.$value['main_image1'])   ?>" width="140" height="140" class="wp-post-image" alt="">
                            </div>
                           </div>
                           <span class="price">
                    ...
                    if(($value['availability'] - $holdlow )>= $value['min_order_quan']){ ?>
...
$("input[name='resc[]']:checked").each( function () {
 ...
 $.ajax({
    ...
    url:"<?php echo base_url('loadscroll/searchresult'); ?>",

...
<div class="body-content">
	...
	<h2 class="heading-title">Sorry , Your Order Failed .</h2>
	<!--<div>-->
	<!--	<a href="<?php echo base_url('Artnhub/index'); ?>"><img src="<?php echo base_url(); ?>assets/images/shopping-with-us.jpg"></a>-->
	<!--</div>-->
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
			</div><!-- /.container -->

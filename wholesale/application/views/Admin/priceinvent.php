...
.btn-group{
 ...
 <aside class="right-side">
                                  ...
                                  <form action="<?php echo base_url('Admin/price_categories'); ?>" method="POST">
                                   ...
                                   <?php 
                            		...
                            		<option value="<?=  $catt->id ?>"  <?php if($subcatid == $catt->id ){echo 'selected';} ?> ><?=  $catt->subcategory_name ?></option>
                                      ...
                                      <div class="col-md-2">
                                             <a href="<?php echo base_url('Admin/price'); ?>" class="btn btn-success">Reset</a>
      </div>
                                        </form>
           ...
           if($user_rm->download == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>clienttable <?php } ?>" style="display:none;">
           ...
           if($user_rm->download == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>clienttable2 <?php } ?>">
                                    ...
                                    ?>
                                       ...
                                       <!--<td><input type="checkbox" name="" id=""></td>-->
                                         ...
                                         <td>
                                          ...
                                          <!--<input type="text" name="" class="form-control" id="category_<?php echo $value['sku_code']; ?>" value='<?php print_r($category); ?>' onchange="category('<?php echo $value['sku_code'] ?>')">-->
                                           ...
                                           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                                <input type="text" name="" class="form-control" id="avail_<?php echo $value['sku_code']; ?>" value="<?=$value['price'];?>" onchange="avail('<?php echo $value['sku_code'] ?>')">
                                               <?php }else{ ?>
                                               <?=$value['price'];?> 
                                               <?php }?>
                                               </td>                            
                                      
                                           <td> <?php if($_SESSION['session_namee'] != 'admin'){ 
                                                $rowid = $_SESSION['session_iid'] ;
                                                $user_rm =  $this->db->get_where('team_role' ,array('user_id' => $rowid ,'navbar_name' => 'BulkPrice' ))->row();
                                           ...
                                           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                           <input type="text" name="" class="form-control" id="sel_<?php echo $value['sku_code']; ?>" value="<?=$value['selling_price'];?>" onchange="selprice('<?php echo $value['sku_code'] ?>')">
                                          <?php }else{ ?>
                                               <?=$value['selling_price'];?> 
                                               <?php }?> </td>
                                        ...
                                        <?php if($_SESSION['session_namee'] != 'admin'){ 
                                           ...
                                           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                           <input type="text" name="" class="form-control" id="availqty_<?php echo $value['sku_code']; ?>" value="<?=$value['availability'];?>" onchange="availqty('<?php echo $value['sku_code'] ?>')">
                                          <?php }else{ ?>
                                               <?=$value['availability'];?> 
                                               <?php }?>   </td>                            
                           ...
                           <td>
                          <p style = "display:none"><?=$value['low_alert'];?></p>
                          <?php if($_SESSION['session_namee'] != 'admin'){ 
                                                $rowid = $_SESSION['session_iid'] ;
                                                $user_rm =  $this->db->get_where('team_role' ,array('user_id' => $rowid ,'navbar_name' => 'BulkPrice' ))->row();
                                           ...
                                           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                           <input type="text" name="" class="form-control" id="low_alert_<?php echo $value['sku_code']; ?>" value="<?=$value['low_alert'];?>" onchange="low_alert('<?php echo $value['sku_code'] ?>')"></td>
                                       <?php }else{ ?>
                                               <?=$value['low_alert'];?> 
                                               <?php }?> 
                                      <td>

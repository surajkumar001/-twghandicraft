...
<section>
    ...
    <form name="form3" method="post" action="<?php echo base_url('Admin/updateoccasion');?>" class="form-group">
<br>
     ...
     <input type="hidden" name="id" value="<?php echo $messages[0]['id']; ?>">
        ...
        <label>Name </label>
        <input name="cname" type="text"   id="sub_cat"  class="form-control" value="<?php echo $messages[0]['name']; ?>">

...
<!-- ============================================================= SHOPPING CART DROPDOWN : END============================================================= -->
              ...
              <li>
                <div class="dropdown">
                  ...
                  <li class="wd100"><a href="<?php echo base_url('my_ledger'); ?>" class="prof">Account History</a></li>
                  <li class="wd100"><a href="<?php echo base_url('logout'); ?>" class="prof">Logout</a></li>     
                  <li class="wd100"><a href="<?php echo base_url('contact'); ?>" class="prof">Get Support</a></li>     
                </div>
              </li>

...
<style>
    ...
    <div class="container">
      <div class="row">
        ...
        <section>
            <center><h2><u><strong>Logo </strong></u> </h2></center>
            <form  method="post" action="<?php echo base_url('Admin/add_logo');?>" class="form-group" enctype="multipart/form-data">
                <br>
                <link href='https://fonts.googleapis.com/css?family=Dosis|Candal' rel='stylesheet' type='text/css'>
                    ...
                    <br><label>Fav Icon</label>
                    <div style="margin-left: 10px;">
                        <input class="form-control" type="file" name="fav_icon" > 
                    </div>
                    <br>
                    <div class="row" style="padding: 0; margin: 0 -15px 0 -5px;">
                       <?php if($fav_icon[0]['terms']){ ?>
                        <div class="col-md-3" style="margin-bottom: 10px;">
                            <div class="image-area">
                              <img src="<?php echo $fav_icon[0]['terms']; ?>" alt="Preview" style="height:155px;;">
                              </div>
                        </div>
                      <?php } ?>
                    </div>

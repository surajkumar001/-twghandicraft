                ...
                <div class="row">
                    <div class="panel panel-primary filterable">
                        ...
                        <div class="panel-body" style="overflow-x: auto;">
                             <!--<a href="<?php echo base_url('Admin/addproductcart'); ?>" class="btn btn-primary" style="margin-left:30px;"> Add Products in Cart</a>-->
                             
                            <form action="<?= base_url('Admin/neworder_genrated');?>" method="post">
                            <div class="row">
                                  ...
                                  <label>Select Customer</label>
                                    ...
                                    <!-- <ul id="myUL" style="display:none;border: 1px solid #418bca;padding: 5px;">-->
                                            ...
                                            <?php foreach($user as $row ){ ?>
                                                <?php  $phon = $row->phone ; ?>
                                                         <li><a href="<?= base_url('Admin/neworder_genrated_get/'.$phon) ; ?>" ><?=$row->Owner ; ?> ( <?= $phon ; ?> )</a></li>
                                                       <?php  }?>

...
<section>
       <center><h2><u><strong>Shopping Guide </strong></u> </h2></center>
    <form name="form3" method="post" action="<?php echo base_url('Admin/newshoppingguide');?>" class="form-group">
<br>

   <textarea id='editor2' name="id" class="form-control"><?php echo $messages1[0]['terms']; ?></textarea>
...
function send(){
  ...
  var occid= $("#editor").html();
    ...
    $.ajax({
      url: urls+"Admin/newshoppingguide",
      type: "POST",
      data: {id:occid},
      cache: false, 

...
?>
 <aside class="right-side">
           ...
           if($user_rm->upload == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?> 
                            <a href="<?php echo base_url('Admin/Home_Page_Deals'); ?>" class="btn btn-primary">Add New Home Page Category</a> 
                            <?php } ?><br />
                            <br />
           ...
           if($user_rm->download == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>   id="table1" <?php } ?>>
                                <thead>
                                    <tr class="filters">
                                        <th>S.No</th>
                                        <th>Category Name</th> 

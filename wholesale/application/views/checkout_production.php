...
<?php     $id=$_SESSION['session_id'];
    ...
    $production=$this->Adminmodel->select_com_where($table,$where,$id); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- guest-login -->
                                             <div class="col-md-6 col-sm-6 guest-login">
                                                ...
                                                <button type="submit" class="btn-upper btn btn-primary checkout-page-button checkout-continue mg-t-6"  data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" style="width: 50%;">Continue Checkout</button>
                                            </div>
                                            <!-- guest-login -->
                        ...
                        <?php } ?>
                              ...
                              <strong>Email!</strong>Enter Valid Email.
                            		...
                            		<span id="hidebtn">
                            	  	...
                            	  	<span>Or <a class="btn btn-success btnwidth" href="<?php echo base_url('signup'); ?>" style="    width: 68%;">&nbsp;New Customer? Create an Account</a></span>
                            	  	</span>
                            		 	<button type="button" id="showbtn" class="btn-upper btn btn-primary checkout-page-button login" onclick="validationforget();"  style="display:none ;width:20%;">Submit</button>
                            ...
                            <div class="panel panel-default checkout-step-02">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse in">
                                    ...
                                    <div id="collapse2" class="panel panel-default box-1 box-color">
                                      ...
                                      <label><input type="radio"  name="optradios"  value="<?php echo  $value['id'];  ?>" onchange="pincodecheck('<?php echo $value['PinCode']; ?>')"
                                             <?php if($value['PinCode']==$_SESSION['pincodeno']){ echo "checked"; } ?>>
                                               <span class=" tag-1 tag-color">Default </span>
                                            <p><strong><?php echo $value['Owner']; ?><span class="mg-left-2">+91 <?php echo $value['phone']; ?></span></strong></p>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-color-1 " onclick="default_add('<?php echo $value['id']; ?>')" style="width:10%;">Update</button>
                            ...
                            <div class="panel-body">
                                  ...
                                  New Address</a>-->
                                    ...
                                    <button type="button" class="btn-upper btn btn-primary checkout-page-button checkout-continue collapsed "  data-toggle="collapse"data-parent="#accordion" href="#collapseThree" style="width: 25%;margin: 10px;">Deliver Here</button>
        ...
        //=======Order detail database===========                              
                                  ...
                                  if($befor_dis_sub_total >= '40000'   && $befor_dis_sub_total < '100000'  ){
                                    ...
                                    //   echo $befor_dis_sub_total ;
                                      ...
                                      $per_item_dicount[$a] = 0 ; 
                                                 ...
                                                 $sub_total+= ($cart['price']*$cart['quantity']) + $cart['gst'];
                                                 $sub_amount+= ($cart['price']*$cart['quantity']);
                                                 $gst_total+= $cart['gst'] ;
            ...
            <h4 class='cart-product-description'><?php echo $product[0]['sku_code']; ?></h4>
             <input type="hidden" id="pro_id" value="<?php echo $product[0]['sku_code']; ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <span class="product-color font"><i class="fa fa-inr"></i> <span><?php echo $product[0]['selling_price']; ?></span>
                                                            </td>
                                                            <td class="text-center">
                                                                <span class="product-color font"><i class="fa fa-inr"></i> <span><?php echo round($product[0]['selling_price'] -  $per_item_dicount[$a],2) ; ?></span>
                                                            </td>
                                                      </tr>
                                                       <?php 
                                       $finalvolume+=$volume;
                  ...
                  <div class="radio">
                        <label><input type="radio" name="credits" onchange="online_pay(<?php echo round(($_SESSION['totalprice'])/4,2) ?>);"  value="<?php echo round(($_SESSION['totalprice'])/4,2) ?>" ><p>25% payment (<i class="fa fa-inr"></i> <?php echo round(($_SESSION['totalprice'])/4,2) ?> )</p></label>
                    </div>
                    
                    <div class="radio">
                        <label><input type="radio" name="credits" onchange="online_pay(<?php echo round(($_SESSION['totalprice']),2) ?>);" value="<?php echo round(($_SESSION['totalprice']),2) ?>" ><p>100% payment (<i class="fa fa-inr"></i> <?php echo round(($_SESSION['totalprice']),2) ?>)</p></label>
                    </div>
                              </div>  
    ...
    <div class="panel-group ">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row" style="color:red">
                    ...
                    <div class="col-md-6 text-right">
                       (-) <i class="fa fa-inr"></i>
                        ...
                        <?php    }  elseif($cart_value>'100000' && $cart_value< '500000' ){
              ...
              <?php       $over_all_gst =  $gst_total + $_SESSION['del_charge']*18/100 + $_SESSION['packingprice']*12/100 ?>

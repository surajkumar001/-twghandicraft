...
$meta_result =  $this->db->get_where('parent_category', array('id' => $parent_id))->row() ;
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo $parent_name ; ?></li>
            </ol>
        </nav>
    </div>
</div>
...
<section class="section-hot-new-arrivals section-products-carousel-tabs mg-lf-15 fadeInUp">
        <div class="section-products-carousel-tabs-wrap container-fluid slider-color">
            <div class="section-header">
                ...
                <div>
                <a href="<?php echo base_url('view/'.$view); ?>" class="btn btn-info pull-right viewallbtn">View All</a>
                </div>
            ...
            <div class="tab-content">
                <div id="tab-59f89f08825d50" class="tab-pane active" role="tabpanel">
                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:true,&quot;slidesToShow&quot;:7,&quot;autoplay&quot;: true,&quot;slidesToScroll&quot;:7,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:700,&quot;settings&quot;:{&quot;slidesToShow&quot;:2,&quot;slidesToScroll&quot;:2}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:5,&quot;slidesToScroll&quot;:5}}]}">
                ...
                //  $product=$this->Model->select_like_where($table,$where,$id);
                ...
                //  ->get() ;
                 ...
                 $product=$this->Model->select_like_where($table,$where,$id); 
                                    ...
                                    if($detail[0]['status'] == 1 && empty($value[0]['parent_sku'])){
                                    ?>
                                    <div class="product">
                                            ...
                                            <?php } ?>
                                                <div class="product_list_container">
                                                    <div class="product_list_img">
                                                        <img src="<?php echo base_url('assets/product/'.$detail[0]['main_image1'])   ?>" class="wp-post-image" alt="">
                                                    </div>
                                                </div>

...
<section>
    ...
    <form name="form3" method="post" action="<?php echo base_url('Admin/newpromopro');?>" class="form-group" enctype="multipart/form-data">
<br>
        ...
        <input name="excel" type="file"   id="sub_cat"  class="form-control">

            ...
            <section class="content paddingleft_right15">
                <div class="row">
                    <div class="panel panel-primary filterable">
                            ...
                            <table class="table table-striped table-bordered clienttable" style="display:none;">
                                ...
                                <tbody>
                                    ...
                                    foreach ($product_detail as  $value) {
                                        ...
                                        if($value['availability'] <= 20 &&  $value['availability'] > 0){
                        ...
                        <td><p style = "display:none"><?=$value['availability'];?> </p><input type="text" name="" class="form-control" id="avail_<?php echo $value['sku_code']; ?>" value="<?=$value['availability'];?>" onchange="avail('<?php echo $value['sku_code'] ?>')"></td>                            
                                 <?php

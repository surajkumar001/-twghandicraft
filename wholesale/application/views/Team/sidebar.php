                ...
                <div class="page-sidebar  sidebar-nav">
                    ...
                    <ul id="menu" class="page-sidebar-menu">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('Team/manageOrder');?>">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('Team/manageProduct');?>">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('Team/manageSales');?>">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('Team/manageCategory');?>">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('Team/manageUser');?>">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('Team/manageCms');?>">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('Team/managePolicy');?>">
                   ...
                   <?php if($_SESSION['session_namee'] == 'admin'){ ?>
                    ...
                    <?php } ?>
                     <?php if($_SESSION['session_namee'] == 'admin'){ ?>
                        ...
                        <!--    <a href="<?php echo base_url('Team/rmlist');?>">-->
                    ...
                    <?php } ?>
                     <?php if($_SESSION['session_namee'] == 'admin'){ ?>
                        <!--  <li>-->
                        <!--    <a href="<?php echo base_url('Team/productmanagment');?>">-->
                        <!--        <i class="livicon" data-name="medal" data-size="18" data-c="#00bc8c" data-hc="#00bc8c" data-loop="true"></i>-->
                    ...
                    <?php if($_SESSION['session_namee'] == 'admin'){ ?>
                        ...
                        <!--    <a href="<?php echo base_url('Team/neworder');?>">-->
                      ...
                      <?php }else{ ?>
                          <?php if (in_array("1", $priveledges)){ ?>
                              <li>
                                    ...
                                    <a href="<?php echo base_url('Team/orders');?>">
                            ...
                            <li>
                                    ...
                                    <a href="<?php echo base_url('Team/production_orders');?>">

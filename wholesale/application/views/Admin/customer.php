...
#table_wrapper {
 ...
 <aside class="right-side">
           ...
           <?php } ?>
 		        ...
 		        <form action="<?php echo base_url('Admin/customer_filter'); ?>" method="POST">
                        ...
                        <?php } ?>
                            ...
                            <table class="table table-bordered table-responsive" style="display:none;"  <?php if($_SESSION['session_namee'] != 'admin'){ 
                $rowid = $_SESSION['session_iid'] ;
           ...
           if($user_rm->rm_no == $value['Rm_id']   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                    <tr>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                           ...
                                           <?php foreach($rm_list as $rm){ ?>
                                           <option  value="<?= $rm->id ?>" <?php if($rm->id ==$value['Rm_id']){ echo "selected" ; } ?>><?php echo $rm->rm_name ; ?></option>
                                          <?php } ?>

...
<aside class="right-side">
  ...
  <section class="content paddingleft_right15">
	...
	<form method="post" action="<?php echo base_url('Admin/upload');?>" enctype="multipart/form-data">
		<br>
			<div class="col-md-6">
		Parent Sku Code<input type="text" name="psku" class="form-control" value="<?php echo $url; ?>" readonly><br>
		
<!------Varient --->
		
		<input type="text" name="varient" class="form-control" value="child" readonly>
...
<select class="locationMultiple1 form-control" name="pcat[]" onchange="sub()" multiple="multiple">
    ...
    $.fn.select2.defaults.set("theme", "bootstrap");
		...
		<br></div>
			...
			<input type="hidden" value="1" name="minimum"  class="form-control">

      ...
      <table width="100%" style="max-width:600px;margin:0 auto"> 
       <tbody>
        <tr> 
         ...
         <td style="width:50%;text-align:right;color:rgba(255,255,255,0.8);font-family:'Roboto-Medium',sans-serif;font-size:14px;font-style:normal;font-stretch:normal;padding-right:16px"> Order Confirmed </td> 
        </tr> 
       </tbody>
      </table> </td> 
    </tr> 
          ...
          <table width="100%" cellspacing="0" cellpadding="0" style="margin:0 auto;max-width:600px;background:#ffffff"> 
           <tbody>
            <tr style="color:#212121;display:block;margin:0 auto;clear:both;padding:24px 0 4px 0"> 
             <td align="left" valign="top" class="m_-1395459101624560752container"> <p style="padding:0;margin:0;font-size:16px;font-family:'Roboto-Medium',sans-serif"> Item in your order has been Confirmed! </p> <br> </td> 
            </tr> 

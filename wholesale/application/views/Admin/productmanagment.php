...
<style>
 ...
 <aside class="right-side">
                            ...
                            <div class="row" style="padding-left: 0px;padding-right: 50px; margin-left: -15px;">
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control" name="date" id="selectNEWBox">
                                        <option value="All" <?php if($date=='All' ){ echo 'Selected'; } ?> >Select Date</option>
                                        <option value="Month"<?php if($date=='Month' ){ echo 'Selected'; } ?>>Last Month</option>
                                        <option value="Quarter" <?php if($date=='Quarter' ){ echo 'Selected'; } ?>>Last Quarter</option>
                                        <option value="custom" <?php if($date=='custom' ){ echo 'Selected'; } ?>>Select Date Range</option>
                                    </select>
                                </div>
		...
		<option value="<?=  $subcatt->id ?>"  <?php if($subcategory_id == $subcatt->id ){echo 'selected';} ?> ><?=  $subcatt->subcategory_name ?></option>
           ...
           if($user_rm->download == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?> clienttable <?php } ?>" style="width: 99%;overflow-y:auto;">
                                <thead>
                                    <tr class="filters" >
                                        <th>S.No</th>
                                        <th>Image</th>
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        ?>
                                         ...
                                         <td><img src="<?php echo base_url('assets/product/'.$product->main_image1)   ?>" width="50px;" height="50px;"></td>
           ...
           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                          <input type="text"  class="form-control" id="position_<?php echo $position['id']; ?>" 
                                         value="<?=$position['category_position'];?>" onchange="update_pos('<?php echo $position['id'] ?>')">
                                         <?php } ?> 
                                         </td>     

...
#table1_info {
 ...
 <aside class="right-side">
    ...
    <div class="row" style="padding:0px 15px;">
     ...
     <div class="row">
     <table class="table table-hover"   <?php if($_SESSION['session_namee'] != 'admin'){ 
                $rowid = $_SESSION['session_iid'] ;
                $user_rm =  $this->db->get_where('team_role' ,array('user_id' => $rowid ,'navbar_name' => 'ProductionOrder' ))->row();
                
               }
            
           if($user_rm->download == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?> id="table1" <?php } ?> style="display:none" >
                   <thead>
        <tr class="hdn">

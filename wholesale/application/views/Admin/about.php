...
<style>
    ...
    <div class="container">
      <div class="row">
        ...
        <section>
            <center><h2><u><strong>About Us </strong></u> </h2></center>
            <form  method="post" action="<?php echo base_url('Admin/newabout');?>" class="form-group" enctype="multipart/form-data">
                <br>
                <link href='https://fonts.googleapis.com/css?family=Dosis|Candal' rel='stylesheet' type='text/css'>
                
                    <div>
                      <textarea type="text"  name="about" id='editor2' contenteditable  class="form-control"><?php echo $messages[0]['terms']; ?></textarea>
                    </div>
                    <br>
                    ...
                    <div class="row" style="padding: 0; margin: 0 -15px 0 -5px;">
                        <?php $about_img  = $this->db->get('about')->result(); 
                            foreach($about_img as $row) { ?>
                        <div class="col-md-3" style="margin-bottom: 10px;">
                            <div class="image-area">
                              <img src="<?= $row->image ; ?>" alt="Preview" style="height:155px;;">
                              <a class="remove-image" href="<?= base_url("Admin/delete_aboutimg/".$row->id); ?>" style="display: inline;">&#215;</a>
                            </div>
                        </div>
                        <?php } ?>
                    </div>

...
<aside class="right-side">
  ...
  <section class="content paddingleft_right15">
	...
	<form method="post" action="<?php echo base_url('Admin/updateproduct');?>" enctype="multipart/form-data">
		...
		<input type="text" value="<?php echo $mes[0]['category_id']?>" name="cat" class="form-control"><br>
		...
		Sub Category
			...
			<input type="text" value="<?php echo $mes[0]['sub_catid']?>" name="sub_cat" class="form-control"><br>
    ...
    $.fn.select2.defaults.set("theme", "bootstrap");
	 ...
	 <div class="col-md-3">
		 Varient<input type="text" name="varient" value="<?php echo $mes[0]['varient']?>" class="form-control"><br></div>

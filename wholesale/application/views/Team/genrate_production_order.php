...
#table1_info {
 ...
 <aside class="right-side">
            ...
            <section class="content-header">
                <h1> Add Products in Production Cart</h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active"> Add Products in Production Cart</li>
                </ol>
            </section>
            <!-- Main content -->
            <section class="content paddingleft_right15">
                <div class="row" >
                    <div class="panel panel-primary filterable">
                        &nbsp;<!--<a href="<?php echo base_url('Admin/neworder'); ?>" class="btn btn-primary">New Order</a>-->
    ...
    <div class="row" style="padding:0px 15px;">
         <?php  $userid =  $result->id; 
                 ...
                 <li><a href="<?= base_url('Admin/addprodutionadmin2')?>?product_sku=<?=$sku;?>&user_id=<?=$userid;?>&mobile=<?=$mob;?>"><?=$pro->sku_code ; ?></a></li>
                                                       <?php  }?>
                                     </ul>
     ...
     <table class="table table-hover" id="table1" style="display:none" >
        ...
        <tr class="hdn">
          ...
          <th class="cart-total last-item">Total</th>
                    ...
                    <td class="cart-image">
                        <a class="entry-thumbnail" href="<?php echo base_url('p/'.$product[0]['url']); ?>" target="_blank">
                            <img src="<?php echo $product[0]['main_image1']; ?>" class="img50">
                        </a>
                    </td>
                    
                    
                   <td class="cart-product-name-info">
                        <p class='cart-product-description'><a href="<?php echo base_url('p/'.$product[0]['url']); ?>" target="_blank"><?php echo $product[0]['sku_code']; ?></a></h4>
    ...
    <td>  <span class=""><?php echo $var; ?></span></td>
    ...
    //   print_r($carttt) ;
       ...
       <td class="cart-product-quantity">
                                ...
                                <input type="number" onkeydown="return false" value="<?php echo $cart['quantity']; ?>" min="<?php echo $product[0]['min_order_quan']; ?>" style="width: 25%;" id="quantity_<?php echo $cart['product_id']; ?>" onchange="quantityproductionadmin_('<?php echo $cart['product_id']; ?>');">
    ...
    //   print_r($carttt) ;
        ?>
                ...
                <?php } ?>
                 ...
                 <td class="romove-item"><a href="#" title="cancel" class="icon"onclick="delproductionadmin('<?php echo $cart['product_id']; ?>');"><i class="fa fa-trash-o"></i></a></td>
...
// ===New row for New Prduct ====== 
  function addprodutionadmin(){
   ...
   var urls=$("#url").val();
     ...
     // alert(sku);
           $.ajax({
            type: "POST",
            url: urls+"Admin/addprodutionadmin",
 ...
 //====================================
   ...
   function quantityproductionadmin_(id){
...
//=================================================    
       ...
       function delproductionadmin(id){
        ...
        $.ajax({
            type: "POST",
            url: urls+"Admin/delproductionadmin",

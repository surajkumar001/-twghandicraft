...
<div class="body-content">
   <div class="container">
      <div class="terms-conditions-page mg-bt-3">
          ...
          <form action="<?php echo base_url('Artnhub/Pend_offline_order'); ?>"   method="post" enctype="multipart/form-data" >
         <div class="row">
          ...
          <!--</div>-->
              <div class="col-md-8">
                   ...
                   <h4>Pending Payment  :  <?php echo $pend_amount ; ?> Rs. </h4>
                  </div>
            </div>
            <br>
         <div class="row">
            <div class="col-md-2 terms-conditions">
                ...
                <p><?php echo $pend_amount ; ?></p>
                 <input type="hidden" class="form-control" name="advance_amount" value="<?php echo $pend_amount ; ?>"   Placeholder="Min Advance Amount" >
                
                 <input type="hidden" class="form-control" name="order_id" value="<?php echo $order_id ; ?>"  id="Advance"  >
                 <input type="hidden" value="<?php echo $payment_no ; ?>" name="payment_no" >

  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-4">
            <div class="row" style="margin-left: 100px;">
                            <a href="<?php echo base_url('Admin/addcolor');?>" class="btn btn-primary btn-lg">Color</a>
...
<section>
    ...
    <form name="form3" method="post" action="<?php echo base_url('Admin/insertcolor');?>" class="form-group">
<br>
                        ...
                        <br />
                            ...
                            <table class="table table-bordered " id="table1">
                                <thead>
                                    ...
                                    <?php   $messagess = $this->db->get('color')->result_array()?>
                                        ...
                                        <td><?=$value['name'];?></td>
                                           ...
                                           <td><?=$value['category'];?></td>
                                             ...
                                             <td>
                                                ...
                                                <a href="<?php echo base_url('Admin/editcolor/'.$value['id']);?>">

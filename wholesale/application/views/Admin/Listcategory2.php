                ...
                <div class="row">
                    <div class="panel panel-primary ">
                        ...
                        <div class="panel-body">
                              <a href="<?php echo base_url('Admin/category2'); ?>" class="btn btn-default">Add New</a>
                            <table class="table table-bordered " id="table1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         <a href="<?php echo base_url('Admin/Editcategory2/'.$value['id']);?>">
                                                <i class="fa fa-pencil" data-name="info" data-size="28" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="Edit "></i>
                                            </a>

                                           <a href="<?php echo base_url('Admin/deletecategory2/'.$value['id']);?>">

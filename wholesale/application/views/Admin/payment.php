 ...
 <aside class="right-side">
        ...
        <td><?php $trid_pend =  $pend_3_row->pend_transition_id;  if($trid_pend){ echo "TRID:" ; echo $trid_pend ; }else{ echo "UTR: ";  echo  $pend_3_row->pend_utr_number ;  }?></td>
                                  ...
                                  <form  action="<?= base_url('Admin/confirm_payment')?>" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="utr_number" Value="<?php echo  $row->utr_number ?>" required>
                                            </div>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                       <div class="row">
                                         ...
                                         <!--Payment Details-->
                        <div id="pendpayment_<?=$id ?>" class="modal fade" role="dialog">
                          <div class="modal-dialog">
           ...
           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                         <a href="#myModal_<?=$id ?>" data-toggle="modal" ><button type="submit" class="btn btn-primary" >View Slip 1st payment</button><br><br></a>
                                        <?php } } ?>   
                                        <?php if($row->confirm_payment){ ?>
           ...
           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                         <a href="#confirm_<?=$id ?>" data-toggle="modal" ><button type="submit" class="btn btn-success" >Modify 1st payment</button>  </a> 
                                        <?php } ?> 
                                         <?php  }else{?>
                                          <?php if($_SESSION['session_namee'] != 'admin'){ 
                $rowid = $_SESSION['session_iid'] ;
           ...
           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                             <a href="#confirm_<?=$id ?>" data-toggle="modal" ><button type="submit" class="btn btn-success" >Confirm 1st payment </button> </a>   
                                             <?php } 
                                                       } ?>
                                             <br>
                                             <br> <br> <br>  <br> <br> <br> <br>
           ...
           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                         ...
                                         <a href="#myModalpend_<?=$id ?>" data-toggle="modal" ><button type="submit" class="btn btn-primary" >View Slip 2nd payment </button><br><br>
                                        <?php }  }  ?>   
                                        <?php if($pend_row->confirm_payment){ ?>
                                         <?php if($_SESSION['session_namee'] != 'admin'){ 
                $rowid = $_SESSION['session_iid'] ;
           ...
           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                         ...
                                         <a href="#confirmpending_<?=$id ?>" data-toggle="modal" ><button type="submit" class="btn btn-success" >Modify 2nd payment</button>   
                                         <?php } ?>
                                         <?php  }else{?>
                                          <?php if($_SESSION['session_namee'] != 'admin'){ 
                $rowid = $_SESSION['session_iid'] ;
           ...
           if($user_rm->edit == 'Yes'   || $_SESSION['session_namee'] == 'admin' ){ ?>
                                 ...
                                 <tr>
                                     ...
                                     <p><?= $pend_payment_mode = $pend_3_row->pend_payment_type ; ?></p>
                                          ...
                                          <p> <a href="#paymentpend2_<?=$pend_3_row->id ?>" data-toggle="modal" ><button type="submit" class="btn btn-success" >Payment Details</button> </a></p>
                              ...
                              <div class="modal-body">
                                  ...
                                  <form  action="<?= base_url('Admin/confirmpending_payment')?>" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="row">
                                       ...
                                       <div class="col-md-6">
                                                <label>UTR Number : </label>
                                                <input type="text" class="form-control" name="utr_number" Value="<?php echo  $pend_row->pend_utr_number ?>" required>
                                            </div>

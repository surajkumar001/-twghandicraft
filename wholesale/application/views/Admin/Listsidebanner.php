 ...
 <aside class="right-side">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Promotion Banner list</li>
                </ol>
            </section>
            <!-- Main content -->
                    ...
                    <div class="panel panel-primary ">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <i class="livicon" data-name="user" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Promotion Banner list
                            </h4>
                        </div>
                        <br />
                        <div class="panel-body">
                             <a href="<?php echo base_url('Admin/addsidebanner'); ?>" class="btn btn-default">Add New Promotion</a>
                            ...
                            value="<?=$value['position'];?>" onchange="update_parent_pos('<?php echo $value['id'] ?>')"></td>     
                                        ...
                                        <td>
                                          <a href="<?php echo base_url('Admin/editsidebanner/'.$value['id']);?>">
                                                <i class="fa fa-pencil" data-name="info" data-size="28" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="Edit Category"></i>
                                            </a> 

                                            <a href="<?php echo base_url('Admin/deletepromotionimg/'.$value['id']);?>" onclick="return confirm('Are you sure you want to delete this ?');">
...
<script>
    ...
    function update_parent_pos(id){
         ...
         $.ajax({
                type: "POST",
                url: urls+"Admin/promotion_position",

...
<section>
       <center><h2><u><strong>Terms and Condditions </strong></u> </h2></center>
    <form name="form3" method="post" action="<?php echo base_url('Admin/newterms');?>" class="form-group">
<br>

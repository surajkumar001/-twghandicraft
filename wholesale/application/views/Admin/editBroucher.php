...
<section>
    ...
    <form name="form3" method="post" action="<?php echo base_url('Admin/updateBroucher');?>" class="form-group"  enctype="multipart/form-data">
<br>
<input type="hidden" name="id" value="<?php echo  $messages1[0]['id'];  ?>">
        ...
        <input name="file" type="file"   id="sub_cat"  class="form-control">
          <input type="hidden" name="files" value="<?php echo $messages1[0]['Broucher']; ?>">

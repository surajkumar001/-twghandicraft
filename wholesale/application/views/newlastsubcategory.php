...
$meta_result =  $this->db->get_where('sub_category', array('subcategory_name' => $subcategory_name))->row() ;
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('index'); ?>"> Home</a></li>
                 ...
                 <li class="breadcrumb-item"><a href="<?php echo base_url('index'); ?>"><?php echo $parent->name ; ?></a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo $category->name ; ?> </li>
            <li class="breadcrumb-item active" aria-current="page"><?php echo $subcat_name  ; ?> </li>
...
$("input[name='color[]']:checked").each( function () {
 ...
 $.ajax({
    ...
    url: urls +"Loadscroll/filtersubcategory_newarr",
...
<script>
 ...
 var catid = $("#catid").val();
    ...
    function load_data(limit, start)
    {
        ...
        // alert(catid) ; 
      $.ajax({
        url:"<?php echo base_url('loadscroll/subcategory_newarr'); ?>",
        method:"POST",

...
if($display){
		$imagePath = "http://adsfly.in/wholesale//assets/product/";
	} else {
		$imagePath =  "http://adsfly.in/wholesale//assets/product/";
	}

	$reportdetails = array(
		array('Product Image' => $imagePath . "13X0077N000XASS-1.jpg",'Product SKU' => "76X0076M",'Product WP' => "840",'Product Status' => "Low Stock"),
		array('Product Image' => $imagePath . "13X0074S000XHTS-1.jpg",'Product SKU' => "80X0098G",'Product WP' => "620",'Product Status' => "In Stock"),
		array('Product Image' => $imagePath . "13X0077N000XASS-1.jpg",'Product SKU' => "83X0055Y",'Product WP' => "480",'Product Status' => "Outof Stock"),
	);
...
function xlscreation_ajax() {
	...
	require_once $_SERVER['DOCUMENT_ROOT']. 'phpexcel_gd/PHPExcel/Classes/PHPExcel.php';
